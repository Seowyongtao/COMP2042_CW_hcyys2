...
/**
 * For setting up the properties of a steel brick
 */
public class SteelBrick extends Brick {
    ...
    /**
     * If the random number is smaller than the STEEL_PROBABILITY then call the impact() mehtod
     */
    public void impact(){
